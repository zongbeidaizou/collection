...
SalaryData $SalaryDataFromJson(Map<String, dynamic> json) {
  ...
  final List<SalaryDataAdmins>? admins = (json['admins'] as List<dynamic>?)
      ?.map(
          (e) => jsonConvert.convert<SalaryDataAdmins>(e) as SalaryDataAdmins)
      .toList();
  if (admins != null) {
    salaryData.admins = admins;
  }
...
Map<String, dynamic> $SalaryDataToJson(SalaryData entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['admins'] = entity.admins?.map((v) => v.toJson()).toList();
...
SalaryDataAdmins $SalaryDataAdminsFromJson(Map<String, dynamic> json) {
  final SalaryDataAdmins salaryDataAdmins = SalaryDataAdmins();
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    salaryDataAdmins.id = id;
  }
  final String? aName = jsonConvert.convert<String>(json['a_name']);
  if (aName != null) {
    salaryDataAdmins.aName = aName;
  }
  return salaryDataAdmins;
}

Map<String, dynamic> $SalaryDataAdminsToJson(SalaryDataAdmins entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
...
extension SalaryDataAdminsExtension on SalaryDataAdmins {
  SalaryDataAdmins copyWith({
    int? id,
    String? aName,
  }) {
    return SalaryDataAdmins()
