...
SearchEntity $SearchEntityFromJson(Map<String, dynamic> json) {
  ...
  final bool? incompleteResults = jsonConvert.convert<bool>(
      json['incomplete_results']);
  if (incompleteResults != null) {
    searchEntity.incompleteResults = incompleteResults;
  }
  final List<SearchItems>? items = (json['items'] as List<dynamic>?)?.map(
          (e) => jsonConvert.convert<SearchItems>(e) as SearchItems).toList();
  if (items != null) {
...
SearchItems $SearchItemsFromJson(Map<String, dynamic> json) {
  ...
  final SearchItemsOwner? owner = jsonConvert.convert<SearchItemsOwner>(
      json['owner']);
  if (owner != null) {
  ...
  final String? collaboratorsUrl = jsonConvert.convert<String>(
  ...
  final String? issueEventsUrl = jsonConvert.convert<String>(
  ...
  final String? assigneesUrl = jsonConvert.convert<String>(
      json['assignees_url']);
  ...
  final String? gitCommitsUrl = jsonConvert.convert<String>(
  ...
  final String? issueCommentUrl = jsonConvert.convert<String>(
  ...
  final String? downloadsUrl = jsonConvert.convert<String>(
      json['downloads_url']);
  ...
  final String? milestonesUrl = jsonConvert.convert<String>(
      json['milestones_url']);
  if (milestonesUrl != null) {
    searchItems.milestonesUrl = milestonesUrl;
  }
  final String? notificationsUrl = jsonConvert.convert<String>(
  ...
  final String? deploymentsUrl = jsonConvert.convert<String>(
  ...
  final int? stargazersCount = jsonConvert.convert<int>(
  ...
  final int? openIssuesCount = jsonConvert.convert<int>(
      json['open_issues_count']);
  if (openIssuesCount != null) {
    searchItems.openIssuesCount = openIssuesCount;
  }
  final SearchItemsLicense? license = jsonConvert.convert<SearchItemsLicense>(
      json['license']);
  if (license != null) {
  ...
  final String? defaultBranch = jsonConvert.convert<String>(
      json['default_branch']);
...
SearchItemsOwner $SearchItemsOwnerFromJson(Map<String, dynamic> json) {
  ...
  final String? followersUrl = jsonConvert.convert<String>(
      json['followers_url']);
  if (followersUrl != null) {
    searchItemsOwner.followersUrl = followersUrl;
  }
  final String? followingUrl = jsonConvert.convert<String>(
      json['following_url']);
  ...
  final String? subscriptionsUrl = jsonConvert.convert<String>(
      json['subscriptions_url']);
  if (subscriptionsUrl != null) {
    searchItemsOwner.subscriptionsUrl = subscriptionsUrl;
  }
  final String? organizationsUrl = jsonConvert.convert<String>(
  ...
  final String? receivedEventsUrl = jsonConvert.convert<String>(
...
extension SearchItemsOwnerExtension on SearchItemsOwner {
  SearchItemsOwner copyWith({
    String? login,
    int? id,
    String? nodeId,
    String? avatarUrl,
...
extension SearchItemsLicenseExtension on SearchItemsLicense {
  SearchItemsLicense copyWith({
    String? key,
    String? name,
    String? spdxId,
    String? url,
