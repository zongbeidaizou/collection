...
class CollectionLogOtherContactInfo2 {
	...
	factory CollectionLogOtherContactInfo2.fromJson(Map<String, dynamic> json) => $CollectionLogOtherContactInfo2FromJson(json);
...
class CollectionLogOtherContactInfo2Data {
	...
	factory CollectionLogOtherContactInfo2Data.fromJson(Map<String, dynamic> json) => $CollectionLogOtherContactInfo2DataFromJson(json);

	Map<String, dynamic> toJson() => $CollectionLogOtherContactInfo2DataToJson(this);
...
class CollectionLogOtherContactInfo2Links {
	...
	factory CollectionLogOtherContactInfo2Links.fromJson(Map<String, dynamic> json) => $CollectionLogOtherContactInfo2LinksFromJson(json);

	Map<String, dynamic> toJson() => $CollectionLogOtherContactInfo2LinksToJson(this);
...
@JsonSerializable()
class CollectionLogOtherCouponList {
	@JSONField(name: 'a_user_id')
	int? aUserId = 0;
	@JSONField(name: 'b_borrow_id')
	int? bBorrowId = 0;
	@JSONField(name: 'c_period_id')
	int? cPeriodId = 0;
	@JSONField(name: 'd_coupon_chance_id')
	int? dCouponChanceId = 0;
	@JSONField(name: 'e_coupon_prize_id')
	int? eCouponPrizeId = 0;
	@JSONField(name: 'f_discount_rate')
	int? fDiscountRate = 0;
	@JSONField(name: 'g_discount_amount')
	int? gDiscountAmount = 0;
	...
	int? kStatus = 0;
	@JSONField(name: 'l_admin_id')
	int? lAdminId = 0;
	@JSONField(name: 'm_comment')
	int? mComment = 0;
	@JSONField(name: 'created_at')
	String? createdAt = '';

	CollectionLogOtherCouponList();

	factory CollectionLogOtherCouponList.fromJson(Map<String, dynamic> json) => $CollectionLogOtherCouponListFromJson(json);

	Map<String, dynamic> toJson() => $CollectionLogOtherCouponListToJson(this);
...
class CollectionLogOtherOther {
	...
	factory CollectionLogOtherOther.fromJson(Map<String, dynamic> json) => $CollectionLogOtherOtherFromJson(json);
...
class CollectionLogOtherOtherProgress {
	...
	factory CollectionLogOtherOtherProgress.fromJson(Map<String, dynamic> json) => $CollectionLogOtherOtherProgressFromJson(json);
