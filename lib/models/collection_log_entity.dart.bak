...
class CollectionLogOtherContactInfo {
  ...
  factory CollectionLogOtherContactInfo.fromJson(Map<String, dynamic> json) =>
      $CollectionLogOtherContactInfoFromJson(json);
...
class CollectionLogOtherContactInfoCallRecords {
  ...
  factory CollectionLogOtherContactInfoCallRecords.fromJson(
          Map<String, dynamic> json) =>
      $CollectionLogOtherContactInfoCallRecordsFromJson(json);

  Map<String, dynamic> toJson() =>
      $CollectionLogOtherContactInfoCallRecordsToJson(this);
