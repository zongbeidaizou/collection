...
class ExceptionHandle {
  ...
  static final Map<int, NetError> _errorMap = <int, NetError>{
    net_error: NetError(net_error, 'Network abnormality, please check your network!'),
    parse_error: NetError(parse_error, 'Data parsing error!'),
    socket_error: NetError(socket_error, 'Network abnormality, please check your network!'),
    http_error: NetError(http_error, 'Server exception, please try again later!'),
    connect_timeout_error: NetError(connect_timeout_error, 'Connection timed out!'),
