...
class _SmsDialogDialog extends State<SmsDialog> {
  ...
  String replacePlaceholders(String template, CollectionLogOtherRepayInfo info) {
    ...
    final Map<String, dynamic> placeholders = {
      '@expect_repay_amount@' : info.expectRepayAmount,
      '@expect_repay_time@' : info.expectRepayTime,
      '@overdue_days@' : info.overdueDays,
      '@mobile@' : info.mobile,
      '@name@' : info.name,
      '@borrow_amount@' : info.borrowAmount,
      '@loan_amount@' : info.loanAmount,
      '@borrow_days@' : info.borrowDays,
      '@app_name@' : info.appName,
      '@product_name@' : info.productName,
      '@loan_time@' : info.loanTime,
      '@receive_bank@' : info.receiveBank,
      '@receive_bank_no@' : info.receiveBankNo,
      '@account_name@' : info.accountName,
      '@account_no@' : info.accountNo,
      '@account_bank@' : info.accountBank,
      '@before_credit_amount@' : info.beforeCreditAmount,
      '@after_credit_amount@' : info.afterCreditAmount,
      '@change_credit_amount@' : info.changeCreditAmount,
      '@before_credit_fraction@' : info.beforeCreditAmount,
      '@after_credit_fraction@' : info.afterCreditAmount,
      '@change_credit_fraction@' : info.changeCreditFraction
    };
