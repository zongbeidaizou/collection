  ...
  Future<void> maybeShowNotification(
    ...
    await showDialog<void>(
      ...
      builder: (BuildContext dialogContext) {
        final List<String> tips = notificationData
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: [ThemeUtils.getBackgroundColor(context)!, ThemeUtils.getBackgroundColor(context)!],
              ...
              children: <Widget>[
                ...
                Container(
                  margin: const EdgeInsets.all(2),
                    ...
                    child: LineChartTrend(trends:_data.trends!, title:'Repayment Trend', type: 1)),
                Gaps.vGap4,
                Container(
                  margin: const EdgeInsets.all(2),
                    decoration: BoxDecoration(
                    ...
                    child: LineChartTrend(trends:_data.trends!, title:'Marketing Trend', type: 2)),
                Gaps.vGap4,
