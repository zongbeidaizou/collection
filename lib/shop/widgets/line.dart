...
class _LineChart extends StatelessWidget {
  const _LineChart(
      ...
      required this.monthCaseData,
      required this.monthBonusData});
        ...
        getTooltipItems: (touchedSpots) {
          return touchedSpots.map((LineBarSpot touchedSpot) {
            final textStyle = TextStyle(
              color: Colors.white ?? touchedSpot.bar.color ?? Colors.blueGrey,
              fontSize: 14,
            );
            return LineTooltipItem(
                '${dates[touchedSpot.x.toInt()]}\n', textStyle,
                children: [
                  TextSpan(
            ...
            children: <Widget>[
              ...
              Text(
                widget.isShowingMainData
                    ? 'My Daily Bonus Earnings Trend'
                    : 'My Daily Case Recovery Trend',
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 12,
              ...
              Expanded(
                child: Padding(
                  ...
                  child: _LineChart(
                    ...
                    monthBonusData: widget.monthBonusData,
                    monthCaseData: widget.monthCaseData,
                  ),
                ),
              ),
              const SizedBox(
